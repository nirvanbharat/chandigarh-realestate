...
export const metadata: Metadata = {
  title: 'Vision | Nirvan Bharat',
  description:
    'A quiet, considered approach to real estate across the Chandigarh Tricity.',
}
  ...
  return (
    <main>
      <section className="mx-auto max-w-site px-6 md:px-12 py-20">
        <p className="text-[11px] tracking-label uppercase text-muted">Vision</p>
      ...
      <section className="border-t border-hairline">
        <div className="mx-auto max-w-site px-6 md:px-12 py-section grid grid-cols-1 md:grid-cols-12 gap-16">
          ...
          <div className="md:col-span-8 space-y-6 text-ink/80 leading-relaxed max-w-prose">
            <p>
              We represent a small, considered catalogue of listings across
