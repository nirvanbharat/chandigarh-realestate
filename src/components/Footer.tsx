...
export function Footer() {
    return (
        ...
        <div className="mx-auto max-w-site px-6 md:px-12 py-16 grid grid-cols-1 md:grid-cols-3 gap-12" >
            <div>
            <p className="font-serif text-2xl font-light" > Chandigarh Tricity </p>
                < p className = "mt-4 text-xs text-muted leading-relaxed max-w-xs" >
                    A curated catalogue of properties across Chandigarh, Mohali, Panchkula, Zirakpur, and New Chandigarh.
          </p>
                        </div>
                        < div >
                        <p className="text-[11px] tracking-label uppercase text-muted mb-6" >
                            ...
                            < ul className = "space-y-3 text-sm" >
                                ...
                                <Link href="/properties" className = "hover:text-accent transition-colors" >
                                    ...
                                    < li >
                                    <Link href="/locations/chandigarh" className = "hover:text-accent transition-colors" >
                                        Chandigarh
                                        </Link>
                                        </li>
                                        < li >
                                        <Link href="/locations/mohali" className = "hover:text-accent transition-colors" >
                                            Mohali
                                            </Link>
                                            </li>
                                            < li >
            ...
            +91 98765 43210
                ...
                < div className = "border-t border-hairline" >
                    <div className="mx-auto max-w-site px-6 md:px-12 py-6 text-[11px] tracking-label uppercase text-muted flex justify-between" >
                        <span>© { new Date().getFullYear() } Chandigarh Tricity Realty </span>
